        ...
        <>
            ...
            <Flex direction="column" h="100vh">
                <Center
                    flex="1 1 auto"
                    backgroundImage={
                        process.env.PUBLIC_URL + "/img/aboutBg.jpg"
                    }
                    ...
                    <Container mt="-20px" maxW="50rem">
                        <FadeInView duration={2}>
                            ...
                            >
                                ...
                                <Text style={{ "-webkit-text-stroke": "0" }}>
                                    😀
                                </Text>
                            </Heading>
                        </FadeInView>
            ...
            >
                <FadeInView duration={1} distance="30px">
                    <InnerText marginTop="20px">
                        Min is a second year Waterloo ECE student. <br />
                ...
                <FadeInView duration={1} distance="30px">
                    <InnerText>
                        ...
                        <Divider />
                        Min is a puzzle addict, passionate video editor, a
                        novice trumpet and not so novice piano player, as well
                        as a budding programmer.
                    </InnerText>
                    <InnerText marginTop="50px">
                        Min doesn't play much sports, but if he had to choose,
                        his favouries would be ultimate frisbee, kendo, and rock
                        climbing.
                    </InnerText>
                    <InnerText marginTop="50px">
